  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
		<li class="breadcrumb-item">  <a href="{{ route('admin.dashboard.home') }}">{{ __('admin::lang.home') }} </a></li>
       	<li class="breadcrumb-item  active"> {{ __('admin::lang.videos') }} </li>
    </ol>
    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal" action="{{ route('admin.videos.index') }}" method="get">
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
                	@can('create videos')
	                	<a href="{{ route('admin.videos.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                	@endcan
                </div>
        ...
        <div class="card d-none d-md-block">
          <div class="card-header">
          	<div class="row">
          		...
          		<div class="col-12 col-md-3 text-center"><strong>{{ __('admin::lang.videos_url') }}</strong></div>
	          	...
	          	<div class="row">
	          		<div class="col-xs-12 col-md-1 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">{{ $video->videos_id }}</div>
	          			</div>
	          		</div>
	          		<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.title') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $video->videos_title }}</div>
	          			</div>
	          		</div>
	          		<div class="col-12 col-md-3 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				<div class="col-4 d-block d-md-none"><strong>{{ __('admin::lang.videos_url') }}</strong></div>
	          				<div class="col-8 col-md-12">{{ $video->videos_url }}</div>
	          			</div>
	          		</div>
	          		...
	          		<div class="col-12 col-md-2 text-md-center">
	          			<div class="row mb-2 mb-md-0">
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="{{ route('admin.videos.destroy', $video->videos_id) }}">
	          						@csrf
	          						@method('DELETE')
	          						@can('view videos')
			          					<a href="{{ route('admin.videos.show', $video->videos_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	          						@endcan
	          						@can('update videos')
			          					<a href="{{ route('admin.videos.edit', $video->videos_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
	          						@endcan
	          						@can('delete videos')
