  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
		<li class="breadcrumb-item">  <a href="{{ route('admin.dashboard.home') }}">{{ __('admin::lang.home') }} </a></li>
       	<li class="breadcrumb-item  active"> {{ __('admin::lang.advertisements') }} </li>
    </ol>
              ...
              <div class="row">
                <div class="form-group col-12 col-md-1 text-center">
                	@can('create advertisements')
	                	<a href="{{ route('admin.advertisements.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                	@endcan
                </div>
	          				...
	          				<div class="col-8 col-md-12">
	          					<form method="POST" action="{{ route('admin.advertisements.destroy', $advertisement->advertisements_id) }}">
	          						...
	          						@can('view advertisements')
			          					<a href="{{ route('admin.advertisements.show', $advertisement->advertisements_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
	          						@endcan
	          						@can('update advertisements')
			          					<a href="{{ route('admin.advertisements.edit', $advertisement->advertisements_id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
	          						@endcan
