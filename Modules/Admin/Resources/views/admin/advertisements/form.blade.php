          ...
          <div class="tab-pane fade {{ $activeLocale == 'general' ? 'show active' : '' }}" id="general" role="tabpanel" aria-labelledby="general-tab">
            <div class="row">
              <div class="col-lg-9">
                ...
                <div class="form-group row d-none" id="advertisements_color_div">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      @include('admin::layouts.includes.imagePreview', ['name' =>'advertisements_img', 'value' => isset($advertisement) ? $advertisement->advertisements_img : null])
                      @if ($errors->first('advertisements_img'))
                        <div class="invalid-feedback">{{ $errors->first('advertisements_img') }}</div>
                      @endif
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="advertisements_mobile_img">{{ __('admin::lang.mobile_img') }}<span class="text-danger"> *</span></label>
                    <div class="col-md-9">
                      @include('admin::layouts.includes.imagePreview', ['name' => 'advertisements_mobile_img', 'value' => isset($advertisement) ? $advertisement->advertisements_mobile_img : null])
                      @if ($errors->first('advertisements_mobile_img'))
                        <div class="invalid-feedback">{{ $errors->first('advertisements_mobile_img') }}</div>
                      @endif
                    </div>
                </div>
