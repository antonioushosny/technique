    ...
    <div class="container-fluid">
      <div class="animated fadeIn">
        <div class="card">
          ...
          <form class="form-horizontal" action="{{ route('admin.notifications.update', $notification->notifications_id) }}" method="post" enctype="multipart/form-data">
          	@csrf
          	@method('PUT')
          	@include('admin::admin.notifications.form')
