  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{ route('admin.roles.index') }}">{{ __('admin::lang.permissions') }}</a>
      </li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="row">
                  <strong class="col-md-3">{{ __('admin::lang.permissions') }}<span class="text-danger"></span></strong>
                  @foreach ($allActions as $action)
                    <strong class="col-md-1 px-0">{{ __('admin::lang.'. $action) }}</strong>
                  @endforeach
                </div>
                @foreach ($allPages as $page)
                  <div class="row">
                    <label class="col-md-3">{{ __('admin::lang.'. $page) }}</label>
                    @foreach ($allActions as $action)
                      @php
